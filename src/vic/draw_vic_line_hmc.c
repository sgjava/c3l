...
void drawVicLineHMc(const bitmap *bmp, const unsigned int x, const unsigned int y, const unsigned int len,
	...
	static const unsigned char leftTable[4][3] = { { 0xc0, 0xf0, 0xfc }, { 0x15, 0x05, 0x01 }, { 0x2a, 0x0a, 0x02 }, { 0x3f, 0x0f,
			0x03 } };
	// Colors 0-3 right fill pixels
	static const unsigned char rightTable[4][3] = { { 0x3f, 0x0f, 0x03 }, { 0x40, 0x50, 0x54 }, { 0x80, 0xa0, 0xa8 }, { 0xc0, 0xf0,
			0xfc } };
